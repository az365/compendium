...
- курсы
  - `free` `course` [Stepik - Основы статистики](https://stepik.org/76) (3-4ч/нед)
    - intro: ген.совокупность и выборка, типы переменных, меры центральной тенденции, изменчивости, квартили и box-plot, нормальное распределение, ЦПТ, доверительные интервалы среднего, стат-вывод, p-value
